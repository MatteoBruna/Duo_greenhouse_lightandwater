...
char config[6] = {0, 0, 0, 0, 0};//per qualche cazzo di motivo se dichiaro queste variabili una per una e  fuori da setup e loop (quindi come global variables) il http non funziona e ritorna l'html invece del json
