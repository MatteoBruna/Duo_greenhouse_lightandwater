...
void setupWiFi() {
  ...
  WiFi.setCredentials("SSID-1", "Pass-1", WPA2, WLAN_CIPHER_AES);
  WiFi.setCredentials("SSID-2", "Pass-2", WPA2, WLAN_CIPHER_AES);
  WiFi.connect();
...
#ifndef TOKEN
#define TOKEN "blablabla token"  // Add here your Ubidots TOKEN
#endif
