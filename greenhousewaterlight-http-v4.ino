...
unsigned char ll1=0; //per qualche cazzo di motivo se le metto fuori da setup e loop (quindi come global variables) il http non funziona e ritorna l'html invece del json
unsigned char ll2=0;
unsigned char ll3=0;
unsigned char v1=0;
unsigned char v2=0;
...
//Serial.println(response.body);
    ...
    ll3=1; Serial.println("primo else if");
    }
    else if (index_on > index_off) { //light off
    ll3=0; Serial.println("secondo else if");
    }
...
Serial.println("appena scaricati: valore v1="+ String(v1)+"  valore v2=" + String(v2));
...
Serial.println("ll1= " + String(ll1) + " ll2=" + String(ll2) + " ll3=" + String(ll3) + " hour=" + String(hour) + " automode=" + String(automode) + " v1=" + String(v1)+ " v2=" + String(v2));
